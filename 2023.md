...
<!-- **The reproducibility reviews are published on OSF at 👉 [https://osf.io/2k56f/](https://osf.io/2k56f/) 👈**. -->
...
2. Send an email to the reproducibility chair with a few words about why you want to join and your user name for the AGILE Discourse server, your Google-account email for accessing non-public Google Docs, and a link to your profile on [OSF](https://osf.io/).
