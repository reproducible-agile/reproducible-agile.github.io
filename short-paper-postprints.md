...
2. Download the file and add a statement to the first page clearly documenting the paper's origin.
   ...
   ~~_This online application can help you with the cover page:_~~ The online application for stamping your PDF is _not available_ anymore, but you can run it from source here: [source code](https://github.com/reproducible-agile/agile-postprint-stamp).
