---
layout: page
title: Reproducible Research @ AGILE '25
keywords:
...
The Reproducible AGILE team is happy to contribute to the AGILE conference 2025 by organising the reproducibility review, continueing an exemplary practice in Open Scholarship from the previous years.
For the fifth time, a reproducibility review is conducted with all accepted full papers based on the mandatory [AGILE Reproducible Paper Guidelines](https://doi.org/10.17605/OSF.IO/CB7Z8).
For the first time, non-compliance with the guidelines, i.e., not including a Data and Software Availability section in the submission, will lead to a desk reject.

<!--

**The reproducibility reviews are published on OSF at 👉 <https://osf.io/t8qw5/> 👈**.
...
Reproducibility committee chair XYZ presented an overview on the reproducibility review process and its results at the final day of the conference.
...
Find all details about the conference and the submission guidelines, including information about the reproducibility guidelines and review on the conference website: <https://agile-online.org/conference-2025>.
...
1. Some **time** in March/April 2025 (see [conference schedule](https://agile-gi.eu/conference-2025/important-dates-2025)). The reproducibility reviews will be conducted after notification of full paper acceptance (5 March 2025) and must be completed ideally before the camera-ready papers are due (10 April 2025) so that authors may include feedback in their final revision.
   Publication of the reproducibility review report will take place later when the proceedings are published to ensure proper cross-referencing. The publication is coordinated by the co-chairs and the publisher.
...
2. Send an [email to Daniel](mailto:daniel.nuest@tu-dresden.de) with a few words about why you want to join and your user name for the AGILE Discourse server, your email for accessing non-public Google Docs, and a link to your profile on [OSF](https://osf.io/).
3. Daniel will send you a short welcome message and invite you to the internal reproducibility review coordination forum.
