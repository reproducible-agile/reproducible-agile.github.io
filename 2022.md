...
Reproducibility committee chair Daniel Nüst reports on the results of the 2021 reproducibility review during the conference.
...
1. Some **time** in April/May 2022 (see [conference schedule](https://agile-online.org/conference-2021/important-dates-2021)). The reproducibility reviews will be conducted after notification of full paper acceptance and must be completed before camera-ready papers are due so that the reference to the reproducibility report can be added.
